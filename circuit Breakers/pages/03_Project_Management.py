...
if st.session_state.new_task:
    ...
    with st.form("task_form"):
        ...
        if editing:
            ...
            # Set default to "Other" (index 6) if category not found
            category_index = TASK_CATEGORIES.index(task_to_edit.get("category", "Other")) if task_to_edit.get("category") in TASK_CATEGORIES else 6
            ...
            category_index = 6  # Default to "Other" category (last item in TASK_CATEGORIES)
